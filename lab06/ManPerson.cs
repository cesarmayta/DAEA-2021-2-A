...
namespace lab06
{
    public partial class ManPerson : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from Person where PersonID = @PersonId", con);
            //cmd.Parameters.Add("@PersonID", SqlDbType.Int).SourceColumn = valEliminar;
            //cmd.Parameters.AddWithValue("@PersonID", Convert.ToInt32("PersonID"));
            cmd.Parameters.Add("@PersonID", SqlDbType.VarChar).SourceColumn = txtPersonID.Text;
